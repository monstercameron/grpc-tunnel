...
const (
	...
	TodoService_ListTodos_FullMethodName       = "/TodoService/ListTodos"
	TodoService_UpdateTodo_FullMethodName      = "/TodoService/UpdateTodo"
	TodoService_DeleteTodo_FullMethodName      = "/TodoService/DeleteTodo"
	TodoService_StreamTodos_FullMethodName     = "/TodoService/StreamTodos"
	TodoService_BulkCreateTodos_FullMethodName = "/TodoService/BulkCreateTodos"
	TodoService_SyncTodos_FullMethodName       = "/TodoService/SyncTodos"
)
...
type TodoServiceClient interface {
	...
	StreamTodos(ctx context.Context, in *StreamTodosRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamTodosResponse], error)
	BulkCreateTodos(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[BulkCreateRequest, BulkCreateResponse], error)
	SyncTodos(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SyncRequest, SyncResponse], error)
}
...
func (c *todoServiceClient) StreamTodos(ctx context.Context, in *StreamTodosRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamTodosResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TodoService_ServiceDesc.Streams[0], TodoService_StreamTodos_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamTodosRequest, StreamTodosResponse]{ClientStream: stream}
...
type TodoService_StreamTodosClient = grpc.ServerStreamingClient[StreamTodosResponse]

func (c *todoServiceClient) BulkCreateTodos(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[BulkCreateRequest, BulkCreateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_BulkCreateTodosClient = grpc.ClientStreamingClient[BulkCreateRequest, BulkCreateResponse]

func (c *todoServiceClient) SyncTodos(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SyncRequest, SyncResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TodoService_ServiceDesc.Streams[2], TodoService_SyncTodos_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_SyncTodosClient = grpc.BidiStreamingClient[SyncRequest, SyncResponse]
...
type TodoServiceServer interface {
	...
	// Streaming RPCs - tests browser HTTP/2 limitations
	StreamTodos(*StreamTodosRequest, grpc.ServerStreamingServer[StreamTodosResponse]) error
	BulkCreateTodos(grpc.ClientStreamingServer[BulkCreateRequest, BulkCreateResponse]) error
	SyncTodos(grpc.BidiStreamingServer[SyncRequest, SyncResponse]) error
...
func (UnimplementedTodoServiceServer) StreamTodos(*StreamTodosRequest, grpc.ServerStreamingServer[StreamTodosResponse]) error {
	return status.Errorf(codes.Unimplemented, "method StreamTodos not implemented")
}
func (UnimplementedTodoServiceServer) BulkCreateTodos(grpc.ClientStreamingServer[BulkCreateRequest, BulkCreateResponse]) error {
	return status.Errorf(codes.Unimplemented, "method BulkCreateTodos not implemented")
}
func (UnimplementedTodoServiceServer) SyncTodos(grpc.BidiStreamingServer[SyncRequest, SyncResponse]) error {
...
func _TodoService_StreamTodos_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamTodosRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TodoServiceServer).StreamTodos(m, &grpc.GenericServerStream[StreamTodosRequest, StreamTodosResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_StreamTodosServer = grpc.ServerStreamingServer[StreamTodosResponse]

func _TodoService_BulkCreateTodos_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TodoServiceServer).BulkCreateTodos(&grpc.GenericServerStream[BulkCreateRequest, BulkCreateResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_BulkCreateTodosServer = grpc.ClientStreamingServer[BulkCreateRequest, BulkCreateResponse]

func _TodoService_SyncTodos_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TodoServiceServer).SyncTodos(&grpc.GenericServerStream[SyncRequest, SyncResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_SyncTodosServer = grpc.BidiStreamingServer[SyncRequest, SyncResponse]
