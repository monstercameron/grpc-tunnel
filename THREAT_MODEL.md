...
| Connection flood / slow consumer | Resource exhaustion | Set server timeouts, read limits, keepalive, and bounded buffering |
...
| Reconnect storm behavior | Availability degradation | Use bounded reconnect backoff (`ReconnectConfig`) and monitor failures |
...
- Origin policy is explicitly configured for production environments.
